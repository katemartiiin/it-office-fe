    ...
    <div class="w-full mb-12 px-4">
      ...
      >
        <div class="px-10 py-5">
          <h1 class="text-xl font-bold mb-5">Create Assessment</h1>
          <form class="w-full">
            <div
              class="flex flex-wrap mb-6 grid md:grid-cols-4 grid-cols-2 gap-2"
            >
              <div
              ...
              <input
                class="ml-5 appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded px-3 py-1 focus:outline-none focus:bg-white focus:border-gray-500"
                id="grid-others"
                type="text"
                placeholder="Others"
              />
            ...
            <div class="flex flex-wrap mb-6">
              ...
              <div class="w-full py-2">
                ...
                >
                <input
                  class="appearance-none block w-full bg-gray-100 text-gray-700 leading-tight border border-gray-200 rounded py-3 px-4 focus:outline-none focus:bg-white focus:border-gray-500"
                  id="grid-name"
                  type="text"
              ...
              <div class="w-full py-2 flex flex-wrap">
                <div class="w-full md:w-1/2 md:pr-2 py-2">
                  ...
                  <input
                    ...
                    id="grid-age"
                    type="text"
                    placeholder="ex. Teacher, Employee"
                  />
                </div>
                <div class="w-full md:w-1/2 md:pl-2 py-2">
                  <label
                  ...
                  <input
                    ...
                    id="grid-age"
                    type="text"
                    placeholder="ex. Catholic, Muslim"
                  />
                </div>
              </div>
              <div class="w-full py-2 flex flex-wrap">
                <div class="w-full md:w-1/2 md:pr-2 py-2">
                  ...
                  <input
                    ...
                    id="grid-age"
                    type="text"
                    placeholder="ex. 123 Street, Malolos, Bulacan"
                  />
                </div>
                <div class="w-full md:w-1/2 md:pl-2 py-2">
                  <label
            ...
            <div class="flex flex-wrap mb-6">
              ...
              <textarea
                ...
                id="grid-function"
                rows="3"
                placeholder="Inilahad na Suliranin"
              ></textarea>
            </div>
            <div class="flex flex-wrap mb-6">
              <label
                ...
                for="grid-request"
              >
                IV. Pagtaya sa Kasalukuyang Kalagayan:
              </label>
              <textarea
                class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                id="grid-function"
                rows="3"
                placeholder="Pagtaya sa Kasalukuyang Kalagayan"
              ></textarea>
            </div>
            <div class="flex flex-wrap mb-6">
              <label
